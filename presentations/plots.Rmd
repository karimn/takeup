...
knitr::opts_chunk$set(echo = FALSE, message = FALSE, warnings = FALSE, warning = FALSE, cache = TRUE, cache.path = "takeup-figure-cache/", fig.path = "takeup-fig/", fig.align = "center")
...
#|  far condition place greater density >1.25km. Finally, the distribution of 
#|  household distances closely resembles that of the cluster centroid suggesting 
#|  the randomisation succeeded in varying distance cost for each household for the respective condition.
