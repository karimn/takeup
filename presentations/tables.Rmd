...
# Table AX: Learning about Deworming Status
# Panel A: Why do they think that you came for deworming?
# Dependent variable: (1) I saw incentive/signals (2) type (3) Campaign (4) Communication .....
# Bracelet
# Calendar
# Ink
# Control mean
# Panel B: Why do they think that you did not come for deworming?
# Dependent variable:  (1) I saw incentive/signals (2) type (3) Campaign (4) Communication .....
# Bracelet
# Calendar
# Ink
# Control mean
# Note: Reasons stated by respondents that reported X individuals knows their deworming status. Examples of "type" , examples "circumstance"
digits = 3
sob_reason_df %>%
  mutate(
  ...
  mutate(term = factor(term, levels = treat_levels_c)) %>%
  ...
  knitr::kable(
      format = "latex",
      col.names = c("", "Campaign", "Communication", "Social Proximity", "Signal", "Type"),
      escape = FALSE, 
      booktabs = TRUE,
      align = "lccccc", 
  ...
  pack_rows(
    index = c(
      "Panel A: Why do they think that you came for deworming?" = 4,
      "Panel B: Why don't they think that you came for deworming?" = 4
    ), 
    hline_after = TRUE, 
    bold = TRUE
  ) 
