...
As described in Section \ref{intervention} our sampling will be stratified based on individuals' phone ownership (collected in the census).

## Inter-cluster Spillover

We test for the possibility of spillovers or contamination due to cluster proximity. As mentioned in Section \ref{cluster-selection-algorithm} clusters were selected such that there is geographic buffer  between them. However, this is not sufficient guarantee that people would travel farther than we anticipated. 
