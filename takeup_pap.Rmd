...
# Research questions
Our main questions are: (i) Can social signaling incentivize adults to take up deworming treatment? That is, are adults more likely to seek deworming treatment if they can show to others that they did so? (ii) Is individual's decision to deworm influenced by other people's deworming choices? That is, are adults more likely to seek deworming treatment if they can observe others come for treatment? The experiment contains 9 treatment arms to separately identify these mechanisms: 
...
1)  Incentive vs. no incentive treatment. 
The cluster randomization into different incentive arms allows us to identify the effect that social or private incentives have on deworming take-up (comparing 1 vs. 4, 6 or 8). Second, comparing 1 vs. 4 and  8 vs. 6 identifies the combined effect of social incentives (i) acting as reminders, (ii) making observable others' deworming decision and (iii) allowing people to signal their decision.^[We will first compare take-up for non-incentive vs. incentive clusters for the sample of phone and non-phone owners, excluding SMS treatment individuals. In a second step we will only focus on phone-owners to separate the different social incentive effects.]

2) Social vs. no social incentives treatment for text message treatment individuals. Comparing individuals that received reminder plus social information text messages across clusters with and without social incentives, we identify the effect of social signaling on individuals' deworming decisions. Comparing 3 vs. 5 we identify the effect of signaling using ink and comparing 9 vs. 7 the effect of social signaling through bracelets. A comparison only among text message recipients allows us to control for the reminder and social learning effects of ink or bracelets and separately identify signaling. 

3) Text message treatment with social information vs. no text messages for social incentive individuals. 
...
4) Text message reminders and social information treatments vs. no text messages for no incentive individuals.
