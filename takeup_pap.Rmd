...
Below are the hypotheses we will investigate based on the cells in Table \ref{tab:cluster-level-treatment}. A formal description of these hypotheses can be found in the [Analysis] section below.

1.  _Incentive vs. no incentive treatment_ 
    ...
    (ii) Comparing 1 vs. 4 and  6 vs. 8 identifies the combined effect of social incentives (a) acting as reminders, (b) making observable others' deworming decision and (c) allowing people to signal their decision.^[We will first compare take-up for non-incentive vs. incentive clusters for the sample of phone and non-phone owners, excluding SMS treatment individuals. In a second step we will only focus on phone-owners to separate the different social incentive effects.]

2. _Social incentives vs. no social incentives for text message treatment individuals_ 
...
3. _No text message treatment vs. text message reminders and social information_
  ...
  We will test for differences in reminder and social learning effects between (i) and (ii).

4. _Text message reminders and social information treatments vs. no text messages for no incentive individuals_
...
We tested two different social signaling treatments, ink and bracelets, in this experiment. This research is meant to give insight into cost-effective methods to increase deworming take-up among adults. Ink has the advantages of its cost being close to zero, it has low oe private value and it is a well-known indicator for voting participation. However, ink is potentially less visible, not as lasting and might cause mistrust when used for non-voting activities. Bracelets on the other hand are highly visible and are not used as a signal in other contexts. However, bracelets are more expensive to produce and might be privately valued. Given these pros and cons we wanted to see the effect of both on deworming take-up.


5. _Text message treatment with social information vs. no text messages for social incentive individuals_ 
