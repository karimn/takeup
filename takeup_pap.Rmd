...
2) Social information text message treatment vs. no text messages for Ink / Bracelet individuals: a random subsample of phone owners within each ink and bracelet cluster is randomized into receiving no text message (4 and 6 in above table) or receiving a reminder text message that also provides information about other community members deworming treatment take-up. Comparing  
