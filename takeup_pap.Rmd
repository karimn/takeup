...
We tested two different social signaling treatments, ink and bracelets, in this experiment. This research is meant to give insight into cost-effective methods to increase deworming take-up among adults. Ink has the advantages of its cost being close to zero, it has a low or no private value and it is a well-known indicator for voting participation. However, ink is potentially less visible, not as lasting and might cause mistrust when used for non-voting activities. Bracelets on the other hand are highly visible and not associated with voting or other sensitive topics. However, bracelets are more expensive to produce and might be privately valued. Given these advantages and disadvantages we tested both. 
...
* Deworming treatment at a point-of-treatment/central location;
