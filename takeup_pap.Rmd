...
The remainder of this document is organized as follows. Sections \ref{intervention} and \ref{research-questions} describe the intervention and research questions. Section \ref{experiment-design} discusses the experimental design. Section \ref{data-collection} describes the different data collected and sample selection. Finally, Section \ref{analysis} outlines the main empirical specifications.
...
Below are the hypotheses we will investigate based on the cells in Table \ref{tab:cluster-level-treatment}. A formal description of these hypotheses can be found in the  Section \ref{analysis}.
...
We will further use the endline data to try and verify some of the assumptions made in the Section \ref{analysis}. We will compare the accuracy of beliefs about deworming take-up at the community level between social incentives and no social incentives individuals that received text messages. 
