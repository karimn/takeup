...
basic_model_0_fit <- sampling(basic_model_0, data = stan_data, chains = 2, iter = 1000, sample_file = file.path("stanfit", "basic_model_0.csv"), control = lst(adapt_delta = 0.99, max_treedepth = 15))
