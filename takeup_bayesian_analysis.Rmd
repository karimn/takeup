...
basic_model_0_fit <- sampling(basic_model_0, data = stan_data, chains = 8, iter = 1000, sample_file = file.path("stanfit", "basic_model_0.csv"), control = lst(max_treedepth = 15)) # adapt_delta = 0.99, 
```
