...
model_3_fit %>% print(pars = c("hyper_beta_day1", "strata_beta_day1_tau"))
...
mcmc_trace(model_3_posterior_array, pars = c("strata_beta_day1_tau_raw[1]"), np = model_3_np)
...
mcmc_pairs(model_3_posterior_array, 
           regex_pars = c(
             "hyper_intercept_raw", "hyper_treat_beta_day1\\[[1-2],", "hyper_beta_dyn_effect\\[[1-2],[1-3]\\]",
              "strata_beta\\[1,1,[1-3]\\]",
