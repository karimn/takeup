...
fast_sim_mean %>%
  ...
  labs(title = expression(paste("Daily Change in Dynamic Component of ", kappa, " Function")),
       y = expression(paste("Posterior Mean of Dynamic ", kappa))) +
  theme(legend.position = "bottom")
```
...
fast_sim_mean %>% 
  ...
  labs(title = "Deworming Take-up", x = "Incentive/Signal Treatment", y = "Posterior Probability of Deworming", caption = "Points show the mean while line ranges show the 90% probability interval.") +
  theme(legend.position = "bottom")
```
