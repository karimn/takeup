...
param_phone_owners_ate <- tribble(
  ...
  "bracelet",           "control",           "social.info",          "control",             "control",            "sms.control",
  "bracelet",           "control",           "social.info",          "control",             "control",            "social.info",
  "bracelet",           "control",           "social.info",          "calendar",            "control",            "social.info",
  "bracelet",           "control",           "social.info",          "bracelet",            "control",            "sms.control"
) %>%
  bind_rows("close" = ., "far" = ., .id = "dist.pot.group") %>%
  mutate(phone_owner = TRUE)
...
basic_model_1_fit <- sampling(basic_model_1, data = param_stan_data, chains = 8, iter = 100, sample_file = file.path("stanfit", "basic_model_1_1.csv"), control = lst(max_treedepth = 15)) # adapt_delta = 0.99, 
```
