...
nonparam_dyn_stan_data <- prepare_bayesian_analysis_data(
  ...
  hyper_dyn_rho_shape = 1,
  hyper_dyn_rho_scale = 1,
...
# model_3_gp_nonparam <- stan_model(file = "takeup_model_3_gp_dynamic.stan", model_name = "model_3_gp_nonparam")
# model_3_gp_nonparam <- stan_model(file = file.path("stan_models", "takeup_model_3_gp_hazard.stan"), model_name = "model_3_gp_hazard")
...
nonparam_dyn_fit_version <- "testing_3"
...
model_3_fit <- dir("stanfit", pattern = str_interp("model_3_gp_nonparam_${nonparam_dyn_fit_version}_[1-8].csv"), full.names = TRUE) %>% 
  read_stan_csv()
...
model_3_fit %>% print(pars = c("hyper_dyn_rho", "hyper_dyn_alpha"))
