...
dyn_fit_version <- "param_sms_ctrl_2"
```
...
model_3_fit <- dir("stanfit", pattern = str_interp("model_3_${dyn_fit_version}_[2-4].csv"), full.names = TRUE) %>% 
  read_stan_csv()
...
mcmc_pairs(model_3_posterior_array, 
           regex_pars = c(
             "hyper_beta_day1\\[[1-2]", 
             "QR_hyper_beta_baseline_dyn_effect\\[[1-2]\\]", 
