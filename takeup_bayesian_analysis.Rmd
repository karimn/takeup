...
basic_model_1_fit <- sampling(basic_model_1, data = param_stan_data, chains = 8, iter = 100, sample_file = file.path("stanfit", "basic_model_1_4.csv"), control = lst(max_treedepth = 15)) # adapt_delta = 0.99, 
```
...
```{r basic-model-2}
basic_model_2 <- stan_model(file = "takeup_model_2.stan", model_name = "model_2")
basic_model_2_fit <- sampling(basic_model_2, data = dyn_stan_data, chains = 2, iter = 50, sample_file = file.path("stanfit", "basic_model_2_1.csv"), control = lst(max_treedepth = 15)) # adapt_delta = 0.99, 
```