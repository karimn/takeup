...
nonparam_dyn_model_version <- 1

model_3_fit <- nonparam_dyn_stan_data %>% 
  sampling(model_3_gp_nonparam, data = ., 
           chains = 8, iter = 800, control = lst(max_treedepth = 15), # adapt_delta = 0.99, 
           sample_file = file.path("stanfit", str_interp("model_3_gp_nonparam_${nonparam_dyn_model_version}.csv")))

save(nonparam_dyn_stan_data, file = file.path("stan_analysis_data", str_interp("model_3_${nonparam_dyn_model_version}.RData")))
```
...
model_3_fit <- dir("stanfit", pattern = str_interp("model_3_gp_nonparam_${nonparam_dyn_model_version}_[1-8].csv"), full.names = TRUE) %>% 
  read_stan_csv()
...
load(file.path("stan_analysis_data", str_interp("model_3_${nonparam_dyn_model_version}.RData")))
```
