...
$$
\Pr[Y_i = 1 | T_i = t, H_i, X_i] = \Pr[Y^*_i(t|H_i, X_i) > 0]
$$
...
U(t, h; \beta) &= U(z^p, z^r, d, s, b, h; \beta) \\
               &= \sum_{w\in\widetilde{Z}^p} \left\{Z^p_w(z^p)\times\beta^p_1 + Z^p_w(z^p)\times h\times\beta^p_2\right\} \\
                                                {} &+ \sum_{w\in\widetilde{Z}^r} \left\{Z^r_w(z^r)\times\beta^r_1 + Z^r_w(z^r)\times h\times\beta^r_2 + Z^r_w(z^r)\times d \times \beta^r_3 + Z^r_w(z^r)\times h\times d\times\beta^r_4 + Z^r_w(z^r)\times b \times \beta^r_5 + Z^r_w(z^r)\times h\times b\times\beta^r_6\right\} \\
                                                {} &+ \sum_{w\in\widetilde{S}} \left\{S_w(s)\times\beta^s_1 + S_w(s)\times h\times\beta^s_2 + S_w(s)\times d \times \beta^s_3 + S_w(s)\times h\times d\times\beta^s_4 + S_w(S)\times b \times \beta^s_5 + S_w(s)\times h\times b\times\beta^s_6\right\} \\
                                                {} &+ \sum_{u\in\widetilde{Z}^r}\sum_{w\in\widetilde{S}} Z^r_u(z^r) \times \left\{S_w(s)\times\beta^s_1 + S_w(s)\times h\times\beta^s_2 + S_w(s)\times d \times \beta^s_3 + S_w(s)\times h\times d\times\beta^s_4 + S_w(S)\times b \times \beta^s_5 + S_w(s)\times h\times b\times\beta^s_6\right\} \\
...
```{r}
basic_model_1_fit <- dir("stanfit", pattern = "basic_model_1_11_[1-8].csv", full.names = TRUE) %>% 
  read_stan_csv()
```
