...
```{r dyn-extra-treatments, eval=FALSE}
dyn_extra_treatments <- 
  tribble(
    ~ private_value, ~ social_value, ~ signal_observed, ~ reminder_info_stock, ~ sms.treatment.2, ~ days_observed, ~ days_sms,
    
    "control",       "control",      "control",         "control",             "reminder.only",   12,              12,
    
    "control",       "control",      "control",         "reminder.only",       "reminder.only",   12,              4,
    "control",       "control",      "control",         "reminder.only",       "reminder.only",   12,              6,
    "control",       "control",      "control",         "reminder.only",       "reminder.only",   12,              8,
    "control",       "control",      "control",         "reminder.only",       "reminder.only",   12,              10,
    
    "control",       "control",      "control",         "social.info",         "social.info",     12,              4,
    "control",       "control",      "control",         "social.info",         "social.info",     12,              6,
    "control",       "control",      "control",         "social.info",         "social.info",     12,              8,
    "control",       "control",      "control",         "social.info",         "social.info",     12,              10,
    
    "control",       "ink",          "control",         "social.info",         "social.info",     12,              4,
    "control",       "ink",          "control",         "social.info",         "social.info",     12,              6,
    "control",       "ink",          "control",         "social.info",         "social.info",     12,              8,
    "control",       "ink",          "control",         "social.info",         "social.info",     12,              10,
    
    "calendar",      "control",      "control",         "social.info",         "social.info",     12,              4,
    "calendar",      "control",      "control",         "social.info",         "social.info",     12,              6,
    "calendar",      "control",      "control",         "social.info",         "social.info",     12,              8,
    "calendar",      "control",      "control",         "social.info",         "social.info",     12,              10,
    
    "control",       "bracelet",     "control",         "social.info",         "social.info",     12,              4,
    "control",       "bracelet",     "control",         "social.info",         "social.info",     12,              6,
    "control",       "bracelet",     "control",         "social.info",         "social.info",     12,              8,
    "control",       "bracelet",     "control",         "social.info",         "social.info",     12,              10,
    
    "control",       "ink",          "control",         "social.info",         "social.info",     12,              12
  )
# expand(dist.pot.group = c("close", "far"), nesting_(names(.)))

    # "control",       "ink",          "ink",             "control",             "sms.control",     0,               12,
    # "control",       "ink",          "ink",             "control",             "sms.control",     2,               12,
    # "control",       "ink",          "ink",             "control",             "sms.control",     4,               12,
    # "control",       "ink",          "ink",             "control",             "sms.control",     6,               12,
    # "control",       "ink",          "ink",             "control",             "sms.control",     8,               12,
    # "control",       "ink",          "ink",             "control",             "sms.control",     10,              12,
```
...
basic_model_2_simple_fit <- dyn_stan_data %>% 
  sampling(basic_model_2_simple, data = ., #init = .$dynamic_initializer,
           ...
           sample_file = file.path("stanfit", "basic_model_2_simple_centered_5.csv")) 

save(dyn_stan_data, file = file.path("stan_analysis_data", "model_2_5.RData"))
```

```{r basic-model-2-simple-debug, eval=FALSE}
basic_model_2_simple_fit <- dyn_stan_data %>% 
  sampling(basic_model_2_simple, data = ., #init = .$dynamic_initializer,
           chains = 8, iter = 100, control = lst(max_treedepth = 15)) # adapt_delta = 0.99, 
```
...
basic_model_2_simple_fit <- dir("stanfit", pattern = str_interp("basic_model_2_simple_centered_${dyn_model_version}_[1-8].csv"), full.names = TRUE) %>% 
  read_stan_csv()
...
load(file.path("stan_analysis_data", str_interp("model_2_${dyn_model_version}.RData")))
```
