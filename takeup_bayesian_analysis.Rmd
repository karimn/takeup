...
basic_model_1_fit <- sampling(basic_model_1, data = param_stan_data, chains = 2, iter = 800, sample_file = file.path("stanfit", "basic_model_1_13.csv"), control = lst(max_treedepth = 15)) # adapt_delta = 0.99,
```
