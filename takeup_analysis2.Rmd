...
The above graph seems to show that conditional on someone in my household having a calendar my desire for a calendar is the same regardless of whether I already have a calendar (i.e. dewormed) or do not have a calendar (i.e. not dewormed). Meaning one of my household members obtaining a calendar is the same as me having a calendar? Private valuation drops massively, which means we cannot think of the calendar as an individual level incentive. I tried to create the same graph for bracelets to see if there is a similar substitution effect or (hopefully not) a complementarity. I could not find the $hh_bra$ variable in the analysis data set and so far been unable to merge it in from the endline data.  
