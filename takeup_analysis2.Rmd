...
Below we are linking the consent, census (including take-up status), and endline data to generate the analysis data set. At this stage, we are including everyone in the cenus--the entire cluster populations. For our analysis, we will filter on consent. (Code moved to separate script).
