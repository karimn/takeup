...
params:
  structural_takeup_version: "60,62" 
...
dist_fit_data %<>% 
  mutate(
    model = fct_expand(model, c("STRUCTURAL_LINEAR_U_SHOCKS_PRIOR", "STRUCTURAL_LINEAR_U_SHOCKS_NO_BELIEFS_DIST_PRIOR", "REDUCED_FORM_NO_RESTRICT_PRIOR")),
