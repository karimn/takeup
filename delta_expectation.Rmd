...
dist_prob_plot <- dist_fit_data %>% 
  ...
  transmute(
    across(c(cluster_takeup_prop_control, cluster_takeup_prop_bracelet, cluster_takeup_prop_ink), map, ~ mutate(.x, roc_distance = roc_distance / 1000)),
