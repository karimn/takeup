...
```{r beliefs-line-plot, fig.width=8, fig.height=8}
...
```{r beliefs-hist, fig.width=8, fig.height=8}
plot_beliefs_hist <- function(beliefs_results, binwidth = NULL) {
  pos_dodge <- position_dodge(width = 0.3)
...
# beliefs_prior_results %>% 
  plot_beliefs_hist(binwidth = 0.02)
```