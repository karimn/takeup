...
load(file.path("temp-data", str_glue("processed_dist_fit{params$takeup_version}.RData")))
...
```{r, eval=FALSE}
load(file.path("/tigress/kn6838/takeup", str_glue("dist_prior{params$takeup_version}.RData")))
dist_prior <- read_rds(dist_fit$STRUCTURAL_LINEAR_U_SHOCKS)

load(file.path("/tigress/kn6838/takeup", str_glue("dist_fit{params$takeup_version}.RData")))
