...
#SBATCH --time=0-6:00:00        # maximum time needed (HH:MM:SS)
...
Rscript postprocess_dist_fit.R ${VERSION} --cores=48 --input-path=${SLURM_INOUT_DIR} --output-path=${SLURM_INOUT_DIR} --load-from-csv 
