...
Rscript run_stan_dist.R fit --models=STRUCTURAL_LINEAR_U_SHOCKS --chains=4 --threads=12 --cmdstanr --include-paths=~/Code/takeup/stan_models --output-path=/tigress/kn6838/takeup --force-iter --iter=400
