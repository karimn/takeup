...
parameters {
  ...
  vector<lower = 0>[num_all_treatment_coef] tau_hyper_beta;
...
transformed parameters {
  ...
  vector[num_all_treatment_coef] hyper_beta = hyper_beta_raw .* tau_hyper_beta;
...
model {
  ...
  tau_hyper_beta ~ student_t(scale_df, 0, scale_sigma);
