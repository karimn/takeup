...
\begin{tikzpicture}[node distance=1cm, auto,]
  ...
  \node[popcircle, below=1.5cm of village2-control, label={below:{\footnotesize\bf{}}}] (non-phone-sms-control-control) {}
  ...
  \node[popcircle, below=1.5cm of village2, label={below:{\footnotesize\bf{}}}] (non-phone-sms-control) {}
    edge[pil] (village1);
