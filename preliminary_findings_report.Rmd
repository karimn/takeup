...
```{r marginal-dist-to-other-pot, fig.height=3, fig.width=6, fig.cap="Marginal Distance to Closest Other Treatment Location. Dashed vertical lines indicate the 10th, 25th, 50th, 75th, and 90th percentiles of the distribution."}
verify.vill.pot.dist %>% 
...
print.reg.table(reg.table.data, caption = "Incentive/signal treatment effects, without SMS treatment.")
