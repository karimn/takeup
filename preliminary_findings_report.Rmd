...
```{r survey-of-10-beliefs, ref.label="survey-of-10-beliefs"}
```

```{r survey-of-10-beliefs-boxplot, ref.label="survey-of-10-beliefs-boxplot"}
```
...
```{r switch-price-wtp, ref.label="switch-price-wtp", fig.cap="Price at which individuals are willing to switch gift choice."}
```
...
```{r tab-test, dependson=c("reg-tab-data", "basic-reg-table"), results="asis", cache=FALSE}
