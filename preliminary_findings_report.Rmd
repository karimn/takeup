...
subtitle: "Preliminary Findings -- Do Not Cite or Distribute"
date: "July 2017"
author:
...
```{r, ref.label="basic-reg-covar", warning=FALSE}
```

```{r, ref.label="sms-reg-covar", warning=FALSE}
```
...
```{r reported-gift-pref-deworm, ref.label="reported-gift-pref-deworm", warning=FALSE}
```

```{r other-incentive-plot, ref.label="other-incentive-plot", warning=FALSE}
```
