...
Before the intervention started, we aimed to conduct baseline surveys with 15 individuals (from unique households) per cluster^[The actual number of individuals that were located varied for all the samples.]. The survey questionnaire covered topics such as:
