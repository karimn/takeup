...
```{r param-dyn-daily-takeup-levels-with-sms, fig.width=7, fig.height=4, fig.cap="Daily take-up non-cumulative proportion for all incentive/signal treatments and SMS treatments (phone owners only)."}
est_deworming_day_all %>% 
  mutate(full_observation = incentive_treatment_static == incentive_treatment_dynamic) %>% 
  filter(full_observation,
         incentive_treatment_static != "bracelet social",
...
```{r param-dyn-daily-takeup-levels-dist, fig.width=7, fig.height=4, fig.cap="Daily take-up non-cumulative proportion for all incentive/signal treatment arms (No SMS treatment), split by distance."}
...
```{r param-dyn-daily-takeup-levels-dist-with-sms, fig.width=8, fig.height=5, fig.cap="Daily take-up non-cumulative proportion for all incentive/signal treatments and SMS treatments (phone owners only), split by distance."}
est_deworming_day_dist %>% 
  mutate(full_observation = incentive_treatment_static == incentive_treatment_dynamic) %>% 
  filter(full_observation,
         incentive_treatment_static != "bracelet social",
