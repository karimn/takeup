...
```{r, ref.label="sim-fast-take-up", fig.width=10, fig.height=7, fig.cap="Posterior distribution of the finite sample average probability of deworming take-up across all treatments and subgroups.", eval=FALSE}
```
...
```{r, ref.label="fast-sim-day-one", fig.width=8, fig.cap="Posterior distribution of the finite sample average treatment effect of SMS treatment on take-up on deworming day one."}
```
