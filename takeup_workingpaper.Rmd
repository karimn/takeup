...
```{r, ref.label="fast-sim-daily-obs-plot", fig.width=9, fig.height=7, fig.cap="Posterior distribution of the daily finite sample average probability of deworming take-up (with no SMS treatment)."}
```
...
```{r, ref.label="fast-sim-daily-ate-obs-plot", fig.width=8, fig.height=7, fig.cap="Posterior distribution of the daily finite sample average treatment effect (with no SMS treatment)."}
```
...
```{r, ref.label="sim-fast-daily-sms-dyn-kappa", fig.width=8, fig.height=7, fig.cap="Posterior distribution of the finite sample dynamic effect of SMS treatment."}
```
