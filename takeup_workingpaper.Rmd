...
In this section we report the posterior distributions of 
...
```{r, ref.label="fast-sim-daily-sms-plot", fig.width=9, fig.cap="Posterior distribution of the daily finite sample average probability of deworming take-up (with SMS treatment)."}
```

```{r, ref.label="sim-fast-daily-sms-dyn-kappa", fig.width=8, fig.height=4, fig.cap="Posterior distribution of the finite sample dynamic effect of SMS treatment."}
```

```{r, ref.label="fast-sim-daily-ate-sms-plot", fig.width=9, fig.height=7, fig.cap="Posterior distribution of the daily finite sample average treatment effect (with SMS treatment)."}
```

```{r, ref.label="fast-sim-takeup-day-one", fig.width=8, fig.cap="Posterior distribution of the finite sample average probability of take-up on deworming day one, for phone owners only and with no SMS treatment."}
```

```{r, ref.label="fast-sim-ate-day-one", fig.width=8, fig.cap="Posterior distribution of the finite sample average treatment effect of SMS treatment on take-up on deworming day one, for phone owners only."}
```

```{r, ref.label="fast-sim-no-obs-plot", fig.width=10, fig.height=7, , fig.cap="Posterior distribution of the finite sample average treatment effect across all treatments and subgroups (comparing treatment with signal and SMS observation with imputed outcomes with no observation)."}
```
