...
Third, we show that the type of signal offered can drastically influence its effectiveness. To our knowledge, this is the first study that simultaneously tests two different signals. Our findings suggest that differences in the perceived salience of signals can translate into large differences in their effectivenes to influence behavior. While ink is a known, well-established signal in Kenya - commonly used for voting - our study highlights that such familiarity does not imply it is transferable as signal to another domain. 
