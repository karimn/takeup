...
```{r, ref.label="static-model-ate-plot", fig.width=8}
```
...
```{r, ref.label="fast-sim-daily-obs-plot", fig.width=9, fig.height=7}
```

```{r, ref.label="fast-sim-daily-dyn-kappa", fig.width=8}
```

```{r, ref.label="fast-sim-daily-ate-obs-plot", fig.width=8, fig.height=7}
```

```{r, ref.label="fast-sim-daily-sms-plot", fig.width=9}
```

```{r, ref.label="sim-fast-daily-sms-dyn-kappa", fig.width=8, fig.height=7}
```

```{r, ref.label="fast-sim-daily-ate-sms-plot", fig.width=9, fig.height=7}
```

```{r, ref.label="sim-fast-take-up", fig.width=10, fig.height=7}
```

```{r, ref.label="fast-sim-ate-plot", fig.width=10, fig.height=7}
```

```{r, ref.label="fast-sim-no-obs-plot", fig.width=10, fig.height=7}
```
...
```{r, ref.label="wtp-model-check-plot"}
```
