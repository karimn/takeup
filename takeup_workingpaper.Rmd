...
wtp_stan_data <- analysis.data %>% 
  ...
  prepare_bayes_wtp_data(
    ...
    preference_value_diff = -seq(0, 100, 10), 
...
```{r wtp-prefer-calendar-plot, fig.height=6, fig.width=8, fig.cap = "Willingness-to-pay experiment results.", dependson="load-wtp-fit"}
wtp_model_0_fit %>% 
