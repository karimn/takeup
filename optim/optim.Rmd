...
params: 
  plot_input_path: "~/projects/takeup/optim/plots/agg-log-full"
  misc_input_path: "~/projects/takeup/optim/plots/agg-log-full"
  data_input_path: "~/projects/takeup/optim/data/agg-log/full"
  many_pots: FALSE
---
...
if (interactive()) {
  params = list(
    plot_input_path = "~/projects/takeup/optim/plots/agg-log-full",
    data_input_path = "~/projects/takeup/optim/data/agg-log-full",
    misc_input_path = "~/projects/takeup/temp-data"
  )
}
library(knitr)
library(tidyverse)
...
```{r, eval = FALSE, echo=FALSE, fig.align="center", fig.cap="Optimal allocation of points of treatment, using calendar treatment. Policymaker aware of signalling. Blue triangles indicate funded PoTs; red triangles unused PoTs; black dots denote villages; and line segments a PoT-village pairing"}
include_graphics(
...
```{r, eval = FALSE, echo=FALSE, fig.align="center", fig.cap="Optimal allocation of points of treatment, using calendar treatment. Policymaker unaware of signalling. Blue triangles indicate funded PoTs; red triangles unused PoTs; black dots denote villages; and line segments a PoT-village pairing"}
include_graphics(
