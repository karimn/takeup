...
# fit_version <- "param_static_nm_test_lvl2_re" # Name matched and SMS, private value separated (bracelet and calendar)
# fit_version <- "param_static_nm_test_lvl2" # Name matched and SMS, private value separated (bracelet and calendar)
# fit_version <- "param_static_2190373" # Name matched and SMS, private value separated (bracelet and calendar)
# fit_version <- "param_static_2188348" # Name matched and SMS, private value separated (bracelet and calendar)
# fit_version <- "param_static_2187538" # Name matched and SMS, private value separated (bracelet and calendar)
...
est_deworming_takeup_ate_phone %>%
  ...
  labs(y = "", subtitle = "For phone owners only, compared to control incentive treatment combined with SMS treatment status.") #+ facet_wrap(~ name_matched_left)
