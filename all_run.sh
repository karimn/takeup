...
# Structural
Rscript ./run_takeup.R takeup prior --models=STRUCTURAL_LINEAR_U_SHOCKS ${CMDSTAN_ARGS} ${OUTPUT_ARGS} --threads=6 --update --outputname=dist_prior${VERSION} --num-mix-groups=1 --sequential
Rscript ./run_takeup.R takeup fit   --models=STRUCTURAL_LINEAR_U_SHOCKS ${CMDSTAN_ARGS} ${OUTPUT_ARGS} --threads=6 --update --outputname=dist_fit${VERSION}   --num-mix-groups=1 --sequential
